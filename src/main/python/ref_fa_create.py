...
sc.single_conf_csv(output_dir, "deepvariant", parabricks_deepvariant_enable)
...
sc.single_conf_csv(output_dir, "haplotype", parabricks_haplotypecaller_enable)
...
sc.single_conf_csv(output_dir, "chord", chord_enable)
